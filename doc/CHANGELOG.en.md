...
- **Real-Time Hover Preview Cards**: Hover over any edge capsule to smoothly slide out a lightweight, interactive preview card without opening the full paper.
  ...
  - **Note Preview**: Lightweight real-time rendering of Markdown formatting, including headings, emphasis, strikethrough, code blocks, lists, and image placeholders.
